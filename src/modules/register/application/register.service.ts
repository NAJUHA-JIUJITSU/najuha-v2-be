...
import { PolicyRepository } from 'src/infra/database/repositories/policy.repository';
import { AuthTokenProvider } from 'src/modules/auth/application/auth-token.provider';
...
import { RegisterUserEntity } from '../domain/registerUser.entity';
