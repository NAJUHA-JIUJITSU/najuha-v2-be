...
import { GoogleUserData } from 'src/infra/sns-auth-client/types/google-user-data.type';
import { SnsAuthStrategy } from 'src/infra/sns-auth-client/types/sns-auth.strategy.type';
